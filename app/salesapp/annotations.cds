using SalesOrderAppService as service from '../../srv/service';
 
annotate service.SOService with @(
    UI.SelectionFields : [
        SO_ID,
        GROSS_AMOUNT,
    ...
    UI.LineItem : [
        ...
        { $Type : 'UI.DataFieldForAction', Action : 'SalesOrderAppService.discountPrice', Label : 'Discount Price',Inline : true},
        ...
        { $Type : 'UI.DataField', Value : PARTNER.ADDRESS.COUNTY }
    ],
...
annotate service.SOItemService with @(
 
    UI.LineItem : [
        { $Type : 'UI.DataField', Value : PO_ITEMS_POS},
        { $Type : 'UI.DataField', Value : PRODUCT_NODE_KEY},
        { $Type : 'UI.DataField', Value : GROSS_AMOUNT },
        { $Type : 'UI.DataField', Value : NET_AMOUNT },
        { $Type : 'UI.DataField', Value : TAX_AMOUNT },
        { $Type : 'UI.DataField', Value : CURRENCY_code }
        ...
        Facets : [
            {
                ...
                Target : '@UI.FieldGroup#ItemPriceInfo'
            },
            {
                $Type : 'UI.ReferenceFacet',
